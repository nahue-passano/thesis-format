...
\section{MARCO TEÓRICO} 
    \input{secciones/2.marco_teorico}

%-----------------Estado del Arte-----------------
\newpage
\section{ESTADO DEL ARTE} 
    \input{secciones/3.estado_del_arte}
...
\section{VALIDACIÓN DE LAS PRUEBAS} 
    \input{secciones/5.validacion_de_las_pruebas}
...
\section{LÍNEAS FUTURAS DE INVESTIGACIÓN} 
    \input{secciones/8.lineas_futuras_de_invetigacion}
